...
static NSString * const DidOpenAPNSMessage = @"DidOpenAPNSMessage";
...
- (NSDictionary<NSString *, id> *)constantsToExport {
  return @{
           ...
           DidOpenAPNSMessage: DidOpenAPNSMessage,
           };
}
...
- (void)didOpenRemoteNotification:(NSDictionary *)userInfo {
    [self.bridge.eventDispatcher sendAppEventWithName:DidOpenAPNSMessage body:userInfo];
}
